// FILE: queue3.h (part of the namespace main_savitch_8B)
...
//   Item& front( )
//     Precondition: size( ) > 0.
//     Postcondition: The return value is a reference to the front item of
...
//     Precondition: size( ) > 0.
//     Postcondition: The return value is a const reference to the front item of
//     the queue (but the queue is unchanged). 
//
