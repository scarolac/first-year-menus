...
//   and
//   binary_tree_node*& left( )              <----- non-const version  *** Modified from Textbook example ***
//   and
//   const binary_tree_node* right( ) const <----- const version
//   and
//   binary_tree_node*& right( )             <----- non-const version  *** Modified from Textbook example ***
